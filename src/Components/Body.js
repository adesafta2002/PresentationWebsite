            ...
            <div className={` ${theme ? "" : "body2_light"} body2`}>
                ...
                <div className={`box1 ${theme ? "" : "box1_lightl"}`}>
                    ...
                    <p> &nbsp; &nbsp;  &nbsp; Hello everyone and welcome to my presentation webiste! I am  an 18 years old Romanian, and a first year 
                        ...
                        the thing i loved doing. After a while, Web Development caught my eye, and I started learning HTML, CSS, JS, and recently I
                         made the jump to React, which is very enjoyable.<br>
                         </br>
                         &nbsp; &nbsp;  &nbsp; Beside this, I have other things I'm passionate about, like Hiking, long  walks on the beach, exploring new cities, and other 
